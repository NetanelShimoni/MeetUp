    ...
    <Dialog open={props.openPopup} maxWidth="xl">
      ...
      <DialogContent>
        ...
        >
          <TextField
            id="create-meetup"
            label="שם יוצר המייטאפ"
            variant="outlined"
            onChange={(e) => changeMeetUp(e)}
          />
          <TextField
            id="title"
            label="כותרת"
        ...
        <RadioGroup style={{ margin: "20px" }}>
          ...
          />
          <FormControlLabel
            value="Zoom & Frontally"
            control={<Radio />}
            label="Zoom & Frontally"
        ...
        <Button
          endIcon={<ExitToApp />}
          onClick={() => props.SetopenPopup(!props.openPopup)}
          variant="contained"
          color="primary"
          style={{
            color: "white",
